...
// Data for product pages based on the request
    ...
    return (
        <main className="min-h-screen bg-[#0d0617] py-32 px-4 sm:px-6 lg:px-8 text-white text-center">
            <div className="max-w-xl mx-auto p-10 rounded-xl border-2 border-red-500 bg-red-900/20">
                <h1 className="text-5xl font-extrabold mb-4 text-red-400">404 - Product Not Found</h1>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {productHub.subPages.map((page) => (
            <a 
              key={page.slug} 
              href={`/product/${product_slug}/${page.slug}`} // Example sub-page link
              className={linkClass}
            >
