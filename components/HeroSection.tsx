...
// ========================================================================
// 1. REMOVED: STANDALONE THEME CONTEXT DEFINITION 
//    (Now imported via useTheme hook above)
// ========================================================================
...
const QuickCTA: React.FC<QuickCTAProps> = ({
  ...
  if (theme === "dark") {
    ...
    const secondaryClasses =
      "text-gray-300 border border-purple-500/50 bg-black/30 backdrop-blur-md " +
    ...
    if (primary) {
      customStyle = { boxShadow: "0 0 15px rgba(123, 0, 255, 0.4)" };
    }
  } else {
    // 🔆 LIGHT MODE STYLES
    const primaryClasses =
      ...
      "hover:from-indigo-500 hover:to-blue-400 transform hover:scale-[1.05]";

    const secondaryClasses =
      "text-gray-700 border border-gray-300 bg-white/70 backdrop-blur-sm " +
      "hover:text-indigo-600 hover:border-indigo-400 shadow-md transform hover:scale-[1.02]";
  ...
  return (
    <a
      ...
      style={customStyle} // Only applies to primary dark mode CTA
    >
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <QuickCTA
              ...
              icon={FileText}
              primary={true}
              href="https://www.p2pclouds.com/documentation"
            />
            {/* CTA 2: Courses (Primary Action) */}
            <QuickCTA
              label="Learn with Courses"
              icon={GraduationCap}
              primary={true}
